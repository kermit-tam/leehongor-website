...
import { allLessons } from '../studyeng/data/cvc-lessons';
import SpellingGame from './components/SpellingGame';

type GameMode = 'menu' | 'spelling';
...
export default function TryEngPage() {
    ...
    <div className="min-h-screen bg-gradient-to-br from-yellow-50 via-pink-50 to-purple-50">
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        <AnimatePresence mode="wait">
            ...
            >
              ...
              >
                <button
                  ...
                  className="w-full relative overflow-hidden rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-[1.02] bg-gradient-to-r from-pink-400 via-purple-400 to-blue-400"
                >
          ...
          {gameMode === 'spelling' && (
            <SpellingGame onExit={() => setGameMode('menu')} />
          )}
        </AnimatePresence>
      </main>
    </div>
