...
const lesson5Units: N5Unit[] = [
  {
    ...
    vocab: [
      ...
      { hiragana: 'かえります', kanji: '帰ります', meaning: '回／回去', cantonese: '返', note: '' },
      { hiragana: 'ちかてつ', kanji: '地下鉄', meaning: '地鐵', cantonese: '地下鐵', note: '' },
      { hiragana: 'しんかんせん', kanji: '新幹線', meaning: '新幹線', cantonese: '新幹線', note: '' },
      { hiragana: 'バス', kanji: '', meaning: '公共汽車', cantonese: '巴士', note: '外來語' },
      { hiragana: 'タクシー', kanji: '', meaning: '出租車', cantonese: '的士', note: '外來語' },
      { hiragana: 'じてんしゃ', kanji: '自転車', meaning: '自行車', cantonese: '單車', note: '' },
      ...
      { hiragana: '…ばんせん', kanji: '…番線', meaning: '第…站臺', cantonese: '第…號月台', note: '' },
      { hiragana: 'つぎの', kanji: '次の', meaning: '下一個', cantonese: '下一個', note: '' },
      { hiragana: 'ふつう', kanji: '普通', meaning: '普通車', cantonese: '普通', note: '' },
      { hiragana: 'きゅうこう', kanji: '急行', meaning: '急行（快車）', cantonese: '急行', note: '' },
      { hiragana: 'とっきゅう', kanji: '特急', meaning: '特快', cantonese: '特急', note: '' },
    ],
    grammar: [
      {
  ...
  },
  {
    ...
    vocab: [
      ...
      { hiragana: 'かれ', kanji: '彼', meaning: '他／男朋友', cantonese: '佢／男朋友', note: '' },
      { hiragana: 'かのじょ', kanji: '彼女', meaning: '她／女朋友', cantonese: '佢／女朋友', note: '' },
      { hiragana: 'かぞく', kanji: '家族', meaning: '家族／家裡人', cantonese: '屋企人', note: '' },
      { hiragana: 'ひとりで', kanji: '一人で', meaning: '一個人／自己', cantonese: '自己一個', note: '' },
      { hiragana: 'がっこう', kanji: '学校', meaning: '學校', cantonese: '學校', note: '' },
      { hiragana: 'スーパー', kanji: '', meaning: '超市', cantonese: '超級市場', note: '外來語' },
      { hiragana: 'えき', kanji: '駅', meaning: '車站', cantonese: '車站', note: '' },
      { hiragana: 'だれ', kanji: '誰', meaning: '誰', cantonese: '邊個', note: '口語' },
      { hiragana: 'どなた', kanji: '何方', meaning: '哪位', cantonese: '邊位', note: '敬語' },
      { hiragana: 'くに', kanji: '国', meaning: '國家', cantonese: '國家', note: '' },
      { hiragana: 'とうきょう', kanji: '東京', meaning: '東京', cantonese: '東京', note: '' },
      { hiragana: 'おおさか', kanji: '大阪', meaning: '大阪', cantonese: '大阪', note: '' },
      { hiragana: 'きょうと', kanji: '京都', meaning: '京都', cantonese: '京都', note: '' },
    ],
    dialogue: [
  ...
  },
  {
    ...
    vocab: [
      ...
      { hiragana: 'こんしゅう', kanji: '今週', meaning: '這週', cantonese: '今個禮拜', note: '' },
      ...
      { hiragana: '…ねん', kanji: '…年', meaning: '…年', cantonese: '…年', note: '' },
      { hiragana: 'なんねん', kanji: '何年', meaning: '幾年', cantonese: '幾多年', note: '' },
      { hiragana: '…がつ', kanji: '…月', meaning: '…月', cantonese: '…月', note: '' },
      { hiragana: 'なんがつ', kanji: '何月', meaning: '幾月', cantonese: '幾月', note: '' },
    ],
    grammar: [
      {
  ...
  },
  {
    ...
    vocab: [
      ...
      { hiragana: 'むいか', kanji: '6日', meaning: '6號', cantonese: '六號', note: '' },
      { hiragana: 'なのか', kanji: '7日', meaning: '7號', cantonese: '七號', note: '' },
      { hiragana: 'ようか', kanji: '8日', meaning: '8號', cantonese: '八號', note: '' },
      { hiragana: 'ここのか', kanji: '9日', meaning: '9號', cantonese: '九號', note: '' },
      { hiragana: 'とおか', kanji: '10日', meaning: '10號', cantonese: '十號', note: '' },
      { hiragana: 'じゅうよっか', kanji: '14日', meaning: '14號', cantonese: '十四號', note: '' },
      { hiragana: 'はつか', kanji: '20日', meaning: '20號', cantonese: '二十號', note: '' },
      { hiragana: 'にじゅうよっか', kanji: '24日', meaning: '24號', cantonese: '二十四號', note: '' },
      { hiragana: '…にち', kanji: '…日', meaning: '…號', cantonese: '…號', note: '' },
      { hiragana: 'なんにち', kanji: '何日', meaning: '幾號', cantonese: '幾號', note: '' },
      { hiragana: 'たんじょうび', kanji: '誕生日', meaning: '生日', cantonese: '生日', note: '' },
      { hiragana: 'いつ', kanji: '', meaning: '什麼時候', cantonese: '幾時', note: '疑問詞' },
      { hiragana: 'そうですね。', kanji: '', meaning: '是啊。', cantonese: '係喎。', note: '會話' },
      { hiragana: 'ありがとうございました。', kanji: '', meaning: '非常感謝。', cantonese: '多謝晒。', note: '過去式感謝' },
      { hiragana: 'どういたしまして。', kanji: '', meaning: '別客氣。', cantonese: '唔使客氣。', note: '會話' },
      { hiragana: 'こうしえん', kanji: '甲子園', meaning: '甲子園（大阪附近）', cantonese: '甲子園', note: '專有名詞' },
      { hiragana: 'おおさかじょう', kanji: '大阪城', meaning: '大阪城', cantonese: '大阪城', note: '專有名詞' },
    ],
    dialogue: [
